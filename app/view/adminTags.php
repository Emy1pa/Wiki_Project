                ...
                <div class="flex flex-wrap -mx-4">
                    ...
                    foreach ($Tags as $Tag): ?>
                        <div class="flex-1  p-4  min-w-md max-w-md">
                            <div class="mt-8">
                            <div class="relative group bg-blue-800 py-3 px-2 w-32 flex flex-col space-y-1 items-center cursor-pointer rounded-md ">
                                    <div >

                                        <span class="text-white text-1xl font-bold capitalize text-center ">
                                            <?= $Tag['nameTag']; ?>
                                            <div class="flex">
                                                ...
                                                <form method="post">
                                                    ...
                                                    <button type="button"
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-5 fill-sky-500 hover:fill-sky-700" viewBox="0 0 348.882 348.882">
